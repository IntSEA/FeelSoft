...
namespace View
{
    public partial class LemmatizedViewer : Form
    {

        public LemmatizedViewer()
        {
            InitializeComponent();
...
#pragma warning restore CS0108 // El miembro oculta el miembro heredado. Falta una contraseña nueva
        ...
        private void Import(ISearchDataSet dataset)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                IList<IPublication> publications2 = processor.LemmatizedPublications(publications);

                ShowInPublicationViewer delegateMethod = new ShowInPublicationViewer(ShowPublicationsInPublicationViewer);
                this.Invoke(delegateMethod, publications2);
            }
